...
unit_system!(
    ...
    [
        ...
        def EnergyRateDensity = EnergyDensity / Time,
        ...
        def PhotonRate = Dimensionless / Time,
        def SourceRate = PhotonRate,
        ...
        constant SWEEP_HYDROGEN_ONLY_CROSS_SECTION = 5.339944e-22 * square_meters,
