...
unit_system!(
    ...
    [
        ...
        unit (comoving_parsec, "comoving pc") = 3.0857e16 * ComovingLength,
        unit (comoving_kiloparsec, "comoving kpc") = 1000 * comoving_parsec,
        unit (comoving_megaparsec, "comoving Mpc") = 1000000 * comoving_parsec,
        unit (comoving_gigaparsec, "comoving Gpc") = 1000000000 * comoving_parsec,
        def H = { h: 1 },
        unit (h, "h") = H,
        def A = { a: 1 },
        unit (a, "a") = A,
