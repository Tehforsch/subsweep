...
unit_system!(
    ...
    [
        ...
        unit (centimeters_cubed_per_s, "cm^3 s^-1") = cubic_centimeters / seconds,
        unit (meters_cubed_per_s, "m^3 s^-1") = cubic_meters / seconds,
        def HeatingTerm = Energy * Volume3D / Time,
        unit (ergs_centimeters_cubed_per_s, "ergs cm^3 s^-1") = ergs * centimeters_cubed_per_s,
        unit (joules_meters_cubed_per_s, "J m^3 s^-1") = joules * cubic_meters / seconds,
