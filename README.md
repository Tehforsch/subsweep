# Raxiom
Raxiom is a code for postprocessing of astrophysical simulations using
the [sweep method for radiative transfer](https://arxiv.org/abs/2207.12848).

It is built using the [`bevy`](https://docs.rs/bevy/*/bevy) entity
component system.  In the following I'll go into a bit more detail
about why I think this is a good fit for HPC simulations:
...
communicate via channels.  This makes testing in the default rust
test framework possible.
...
## Features
At this point, I use Raxiom to do radiative transfer postprocessing of large cosmological simulations.
However, in the past I used the above framework also to implement a parallel Barnes-Hut tree gravity solver 
as well as a simple Smoothed-Particle-Hydrodynamics solver, mainly for demo purposes. However, for now I have
removed this code from the codebase because I need to finish my PhD ;)
